...
namespace ClientMQTT
{
    public partial class Form1 : Form
    {
        ...
        private void button6_Click(object sender, EventArgs e)
        {
            try
            {
                byte[] textC = new byte[] { 0x03, 0x01, 0x0D, 0x05, 0x01, 0x01, 0x24, 0x01, 0x23, 0x06, 0x01, 0x01, 0x07, 0x04, 0x00, 0x00, 0x00, 0x03, 0x08, 0x18, 0x32, 0x31, 0x30, 0x31, 0x2E, 0x30, 0x30, 0x35, 0x33, 0x2C, 0x4E, 0x2C, 0x31, 0x30, 0x35, 0x34, 0x37, 0x2E, 0x30, 0x33, 0x37, 0x31, 0x2C, 0x45 };
                gateway.client.Publish("info/001/7000000009", textC);
            }
            catch (Exception ex)
            {
