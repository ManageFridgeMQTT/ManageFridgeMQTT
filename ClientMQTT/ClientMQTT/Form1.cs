...
namespace ClientMQTT
{
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                byte[] textA = new byte[] { 0x03, 0x01, 0x0A, 0x05, 0x01, 0x00, 0x24, 0x01, 0x03, 0x06, 0x01, 0x00 };
                gateway.client.Publish("info/001/7000000005", textA);
            }
            catch (Exception ex)
            {
        ...
        {
            byte[] textTatA = new byte[] { 0x03, 0x01, 0x0A, 0x05, 0x01, 0x01, 0x24, 0x01, 0x23, 0x06, 0x01, 0x01, 0x07, 0x04, 0x00, 0x00, 0x00, 0x04, 0x08, 0x18, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 };
            gateway.client.Publish("info/001/7000000005", textTatA);
        }
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            try
            {
                byte[] textC = new byte[] { 0x03, 0x01, 0x0C, 0x05, 0x01, 0x00, 0x24, 0x01, 0x03, 0x06, 0x01, 0x00 };
        ...
        private void button6_Click(object sender, EventArgs e)
        {
            try
            {
                byte[] textC = new byte[] { 0x03, 0x01, 0x0C, 0x05, 0x01, 0x01, 0x24, 0x01, 0x23, 0x06, 0x01, 0x01, 0x07, 0x04, 0x00, 0x00, 0x00, 0x03, 0x08, 0x18, 0x32, 0x31, 0x30, 0x31, 0x2E, 0x30, 0x30, 0x35, 0x33, 0x2C, 0x4E, 0x2C, 0x31, 0x30, 0x35, 0x34, 0x37, 0x2E, 0x30, 0x33, 0x37, 0x31, 0x2C, 0x45 };
                gateway.client.Publish("info/001/7000000009", textC);
            }
            catch (Exception ex)
            {
