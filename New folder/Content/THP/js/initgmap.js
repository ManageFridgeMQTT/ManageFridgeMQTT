...
//                '<br/>&nbsp;&nbsp;<p style="color:red;cursor:pointer;text-align:center;font-weight:bold;" ><a href="' + base_url + "Home/Slide?outletID=" + customer.code + '&txt_date=' + $('#txt_date').val() + '" target="_blank">@Utility.Phrase("View") hình ảnh hiện diện tại cửa hàng</a></p>' +
//                '<br/>' +
//                '<br/>' +
//                '</div>';
//        }
...
//                '<br/>&nbsp;&nbsp;<strong>Giờ ra</strong>: ' + customer.end_time +
//                '<br/>&nbsp;&nbsp;<strong>Khoảng cách đến cửa hàng(m)</strong>: ' + customer.distance +
//                '<br/>&nbsp;&nbsp;<p style="color:red;cursor:pointer;text-align:center;font-weight:bold;" ><a href="' + base_url + "Home/Slide?outletID=" + customer.code + '&txt_date=' + $('#txt_date').val() + '" target="_blank">@Utility.Phrase("View") hình ảnh trưng bày</a></p>' +
//                '<br/>' +
//                '<br/>' +
//                '</div>';
//        }
...
pgmap.markerClickFunction = function (order, customer, latlng) {
    ...
    return function (e) {
        ...
        if (customer.status == 2) {
            ...
            infoHtml += '<br/>&nbsp;&nbsp;<p style="color:red;cursor:pointer;text-align:center;font-weight:bold;" ><a href="' + base_url + "Home/Slide?outletID=" + customer.code + '&txt_date=' + $('#txt_date').val() + '" target="_blank">@Utility.Phrase("View") hình ảnh hiện diện tại cửa hàng</a></p>' +
                '<br/>' +
                '<br/>' +
                '</div>';
        }
