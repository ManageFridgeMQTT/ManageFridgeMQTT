...
//Render 1 SM location with Visit Outlet
pgmap.renderSaleman = function () {
    ...
    var marker = new MarkerWithLabel({
        ...
        labelAnchor: new google.maps.Point(pgmap.salemanData.SalesmanName.length * 4, -1),
...
pgmap.renderSalesmenMarkers = function (fromIndex) {
    ...
    for (var i = fromIndex; i < toIndex; i++) {
        ...
        var marker = new MarkerWithLabel({
            ...
            labelAnchor: new google.maps.Point(pgmap.data[i].SalesmanName.length * 4, -1),
            labelClass: "labels"// the CSS class for the label
        });
...
pgmap.markerSalesmenDblClickFunction = function (salesman, latlng) {
    return function (e) {
        filterSaleman(salesman.SalesmanID);
        LoadSalesmanInfo();
        pgmap.salesmanLocation = latlng;
    ...
    if (total > 0) {
        for (var i = fromIndex; i < toIndex; i++) {
            ...
            var marker = new MarkerWithLabel({
                ...
                draggable: false,
                map: pgmap.map,
                icon: base_url + 'Content/THP/img/route.png',
                ...
                //labelAnchor: new google.maps.Point(labelContent.length * 4, 46),
                labelClass: "labelmaps", // the CSS class for the label
                //labelClass: "labels",// the CSS class for the label
    ...
    if (total > 0) {
        for (var i = fromIndex; i < toIndex; i++) {
            ...
            var marker = new MarkerWithLabel({
                ...
                draggable: false,
                map: pgmap.map,
                icon: base_url + 'Content/THP/img/SalesmanID.png',
                //labelContent: '<p class="mcp-order" style="color:' + mcpcolor + ';font-size: 13px;" >' + ((pgmap.data[i].SalesmanID).toString()).substring(0, 2) + '</p>' + '<br>' + '<p class="real-order" style="display:inline;color:blue;background-color:#7cc1f0;" >' + AddFirstZero(pgmap.data[i].ODVisitOrder) + '</p>',
    ...
    if (total > 0) {
        for (var i = fromIndex; i < toIndex; i++) {
            ...
            var marker = new MarkerWithLabel({
                ...
                draggable: false,
                map: pgmap.map,
                icon: base_url + 'Content/THP/img/segment.png',
...
pgmap.renderMarkers = function (fromIndex) {
    ...
    if (totalCustomer > 0) {
        for (var i = fromIndex; i < toIndex; i++) {
            ...
            //alert(base_url + 'Content/THP/img/marker' + outletcolor + '.png');
            ...
            if (pgmap.data[i].Status == '1' && pgmap.data[i].ODOutletID == pgmap.data[i].OutletID) {
                ...
                var marker = new MarkerWithLabel({
                    ...
                    draggable: false,
                    map: pgmap.map,
                    icon: base_url + 'Content/THP/img/markerFFFF00.png', //ODVisitOrder, StartTime
                    labelContent: '<p class="mcp-order" style="color:' + mcpcolor + ';font-size: 13px;" >' + ((pgmap.data[i].VisitOrder).toString()).substring(0, 2) + '</p>' + '<br>' + '<p class="real-order" style="display:inline;color:yellow;background-color:#7cc1f0;" >' + labelContent + '</p>',
                ...
                if (pgmap.data[i].ODVisitOrder === 1) {
                    var marker = new MarkerWithLabel({
                        ...
                        draggable: false,
                        map: pgmap.map,
                        icon: base_url + 'Content/THP/img/marker' + outletcolor + '.png',
                        labelContent: '<p class="mcp-order" style="color:' + mcpcolor + ';font-size: 13px;" >' + ((pgmap.data[i].VisitOrder).toString()).substring(0, 2) + '</p>' + '<br>' + '<p class="real-order" style="display:inline;color:red;background-color:yellow;" >' + labelContent + '</p>',
                        labelAnchor: new google.maps.Point(8, 32),
                        labelClass: "labelmaps", // the CSS class for the label
                        labelStyle: { opacity: 0.75 }
                    });
                ...
                //IF end: ve them co mau do
                    ...
                    var marker = new MarkerWithLabel({
                        ...
                        map: pgmap.map,
                        icon: base_url + 'Content/THP/img/marker' + outletcolor + '.png',
                        labelContent: '<p class="mcp-order" style="color:' + mcpcolor + ';font-size: 13px;" >' + ((pgmap.data[i].VisitOrder).toString()).substring(0, 2) + '</p>' + '<br>' + '<p class="real-order" style="display:inline;color:yellow;background-color:red;" >' + labelContent + '</p>',
                        labelAnchor: new google.maps.Point(8, 32),
                        labelClass: "labelmaps", // the CSS class for the label
                        labelStyle: { opacity: 0.75 }
                    });
                    ...
                    var marker = new MarkerWithLabel({
                        ...
                        map: pgmap.map,
                        icon: base_url + 'Content/THP/img/marker' + outletcolor + '.png',
                        labelContent: '<p class="mcp-order" style="color:' + mcpcolor + ';font-size: 13px;" >' + ((pgmap.data[i].VisitOrder).toString()).substring(0, 2) + '</p>' + '<br>' + '<p class="real-order" style="display:inline;color:blue;background-color:#7cc1f0;" >' + labelContent + '</p>',
                        labelAnchor: new google.maps.Point(8, 32),
                        labelClass: "labelmaps", // the CSS class for the label
                        labelStyle: { opacity: 0.75 }
                    });
            ...
            var fn = pgmap.markerClickFunction(pgmap.data[i].VisitOrder, pgmap.data[i], latLng);
...
pgmap.markerClickFunction = function (order, customer, latlng) {
    ...
    return function (e) {
        ...
        if (customer.Status == 2) {
            ...
            infoHtml += '<br/>&nbsp;&nbsp;<p style="color:red;cursor:pointer;text-align:center;font-weight:bold;" ><a href="' + base_url + "Tracking/Slide?outletID=" + customer.OutletID + '&txt_date=' + $('#txt_date').val() + '" target="_blank">@Utility.Phrase("View") hình ảnh hiện diện tại cửa hàng</a></p>' +
                '<br/>' +
                '<br/>' +
                '</div>';
        }
