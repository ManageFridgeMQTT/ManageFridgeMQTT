...
(function() {
	...
	L.Routing.Itinerary = L.Control.extend({
		...
		options: {
			...
			alternativeClassName: 'leaflet-routing-Itinerary',
			minimizedClassName: 'leaflet-routing-Itinerary',
			itineraryClassName: 'leaflet-routing-Itinerary',
	...
	L.Routing.Localization = {
    	'vi': {
			...
			instructions: {
				...
				'Head':
					['Đi thẳng {dir}', ' trên {road}'],
				'Continue':
					['Tiếp tục {dir}', ' trên {road}'],
				'SlightRight':
					['Chếch sang phải', ' vào {road}'],
				'Right':
					['Quẹo phải', ' vào {road}'],
				'SharpRight':
					['Ngoặt phải', ' vào {road}'],
				...
				'Left':
					['Quẹo trái', ' vào {road}'],
				'SlightLeft':
					['Chếch sang trái', ' vào {road}'],
				'WaypointReached':
					['Địa điểm kết thúc'],
				'Roundabout':
					['Qua vòng xoay {exitStr}', ' để vào đường {road}'],
				'DestinationReached':
					['Điểm đến'],
			},
